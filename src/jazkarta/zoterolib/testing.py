...
import jazkarta.zoterolib


class JazkartaZoterolibLayer(PloneSandboxLayer):
...
JAZKARTA_ZOTEROLIB_ACCEPTANCE_TESTING = FunctionalTesting(
    bases=(
        JAZKARTA_ZOTEROLIB_FIXTURE,
